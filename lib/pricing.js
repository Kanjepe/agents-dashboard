...
const PRICING = {
  ...
  opus: { label: 'opus 4.x', input: 15, output: 75, cacheRead: 1.5, cacheCreate: 18.75 },
  // Opus 4.x — 1M context variant (2x base)
  'opus-1m': { label: 'opus 4.x [1M ctx]', input: 30, output: 150, cacheRead: 3, cacheCreate: 37.5 },
  // Sonnet 4.x (incl. 3.7/4.5/4.6) — default 200k context
  sonnet: { label: 'sonnet 4.x', input: 3, output: 15, cacheRead: 0.3, cacheCreate: 3.75 },
  // Sonnet 4.x — 1M context variant
  'sonnet-1m': { label: 'sonnet 4.x [1M ctx]', input: 6, output: 22.5, cacheRead: 0.6, cacheCreate: 7.5 },
  // Haiku 4.5
  haiku: { label: 'haiku 4.5', input: 1, output: 5, cacheRead: 0.1, cacheCreate: 1.25 },
  // Haiku 3.5
  'haiku-3.5': { label: 'haiku 3.5', input: 0.8, output: 4, cacheRead: 0.08, cacheCreate: 1 },
};
...
export function rateForModel(model) {
  ...
  return (family && PRICING[family]) || DEFAULT;
}
